...
const string strMessageMagic = "ICP Signed Message:\n";
...
int64 GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 256 * COIN;
            ...
            if(nHeight == 1)
            {
            nSubsidy = 17600000 * COIN;
            }

    // Subsidy is cut in half every 825000 blocks
    nSubsidy >>= (nHeight / Params().SubsidyHalvingInterval());

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 34 * 60;
static const int64 nTargetSpacing = 17 * 60;
